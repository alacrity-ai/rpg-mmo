...
export default class GreenhavenArcaniumScene extends BaseTownScene {
    constructor() {
        super('GreenhavenArcaniumScene', 'greenhaven/arcanium.png', null, 'arcanium.wav', 'GreenhavenExterior3Scene');
    }
