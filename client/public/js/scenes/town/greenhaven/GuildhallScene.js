...
export default class GreenhavenGuildhallScene extends BaseTownScene {
    constructor() {
        super('GreenhavenGuildhallScene', 'greenhaven/guildhall.png', null, 'guildhall.wav', 'GreenhavenExterior2Scene');
    }
