...
export default class GreenhavenMarketScene extends BaseTownScene {
    constructor() {
        super('GreenhavenMarketScene', 'greenhaven/market.png', null, 'market.wav', 'GreenhavenExterior3Scene');
    }
