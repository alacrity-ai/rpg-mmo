...
export default class GreenhavenBlacksmithScene extends BaseTownScene {
    constructor() {
        super('GreenhavenBlacksmithScene', 'greenhaven/blacksmith.png', null, 'blacksmith.wav', 'GreenhavenExterior3Scene');
    }
