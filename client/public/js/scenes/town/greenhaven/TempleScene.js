...
export default class GreenhavenTempleScene extends BaseTownScene {
    constructor() {
        super('GreenhavenTempleScene', 'greenhaven/temple.png', null, 'arcanium.wav', 'GreenhavenExterior4Scene');
    }
