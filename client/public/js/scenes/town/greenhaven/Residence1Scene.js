...
export default class GreenhavenResidence1Scene extends BaseTownScene {
    constructor() {
        super('GreenhavenResidence1Scene', 'greenhaven/residence-1.png', null, null, 'GreenhavenExterior3Scene');
    }
