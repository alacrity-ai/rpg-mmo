...
export default class TilfordBlackmarketScene extends BaseTownScene {
    constructor() {
        super('TilfordBlackmarketScene', 'tilford/blackmarket.png', null, 'arcanium.wav', 'TilfordExterior3Scene');
    }
