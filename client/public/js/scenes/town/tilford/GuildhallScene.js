...
export default class TilfordGuildhallScene extends BaseTownScene {
    constructor() {
        super('TilfordGuildhallScene', 'tilford/guildhall.png', null, 'guildhall.wav', 'TilfordExterior3Scene');
    }
