...
export default class TilfordBlacksmithScene extends BaseTownScene {
    constructor() {
        super('TilfordBlacksmithScene', 'tilford/blacksmith.png', null, 'blacksmith.wav', 'TilfordExterior2Scene');
    }
