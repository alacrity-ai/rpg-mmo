...
export default class FrostholmArcaniumScene extends BaseTownScene {
    constructor() {
        super('FrostholmArcaniumScene', 'frostholm/arcanium.png', null, 'arcanium.wav', 'FrostholmExterior2Scene');
    }
