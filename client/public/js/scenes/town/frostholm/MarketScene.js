...
export default class FrostholmMarketScene extends BaseTownScene {
    constructor() {
        super('FrostholmMarketScene', 'frostholm/market.png', null, 'market.wav', 'FrostholmExterior3Scene');
    }
