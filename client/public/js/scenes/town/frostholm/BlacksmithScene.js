...
export default class FrostholmBlacksmithScene extends BaseTownScene {
    constructor() {
        super('FrostholmBlacksmithScene', 'frostholm/blacksmith.png', null, 'blacksmith.wav', 'FrostholmExterior2Scene');
    }
