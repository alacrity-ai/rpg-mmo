...
export default class FrostholmGuildhallScene extends BaseTownScene {
    constructor() {
        super('FrostholmGuildhallScene', 'frostholm/guildhall.png', null, 'guildhall.wav', 'FrostholmExterior3Scene');
    }
