...
export default class GlaciersedgeGuildhallScene extends BaseTownScene {
    constructor() {
        super('GlaciersedgeGuildhallScene', 'glaciersedge/guildhall.png', null, null, 'GlaciersedgeExterior1Scene');
    }
