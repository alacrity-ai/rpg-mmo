...
export default class GlaciersedgeBlacksmithScene extends BaseTownScene {
    constructor() {
        super('GlaciersedgeBlacksmithScene', 'glaciersedge/interior-1.png', null, null, 'GlaciersedgeExterior1Scene');
    }
